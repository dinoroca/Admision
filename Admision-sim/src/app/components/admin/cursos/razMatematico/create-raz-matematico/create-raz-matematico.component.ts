...
@Component({
  selector: 'app-create-raz-matematico',
  templateUrl: './create-raz-matematico.component.html',
  styleUrls: ['./create-raz-matematico.component.css']
})


export class CreateRazMatematicoComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_raz_matematico(this.pregunta, this.token).subscribe(
          response => {
