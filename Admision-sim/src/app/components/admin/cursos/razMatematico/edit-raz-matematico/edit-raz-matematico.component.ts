...
@Component({
  selector: 'app-edit-raz-matematico',
  templateUrl: './edit-raz-matematico.component.html',
  styleUrls: ['./edit-raz-matematico.component.css']
})


export class EditRazMatematicoComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_raz_matematico(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_raz_matematico(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              this._router.navigate(['/admin/raz-matematico']);
            }
