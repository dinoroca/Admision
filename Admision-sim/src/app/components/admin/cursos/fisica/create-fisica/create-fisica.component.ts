...
@Component({
  selector: 'app-create-fisica',
  templateUrl: './create-fisica.component.html',
  styleUrls: ['./create-fisica.component.css']
})

export class CreateFisicaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_fisica(this.pregunta, this.token).subscribe(
          response => {
