...
@Component({
  selector: 'app-create-historia-peru',
  templateUrl: './create-historia-peru.component.html',
  styleUrls: ['./create-historia-peru.component.css']
})


export class CreateHistoriaPeruComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_historia_peru(this.pregunta, this.token).subscribe(
          response => {
