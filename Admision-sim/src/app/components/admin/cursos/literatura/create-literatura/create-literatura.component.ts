...
@Component({
  selector: 'app-create-literatura',
  templateUrl: './create-literatura.component.html',
  styleUrls: ['./create-literatura.component.css']
})


export class CreateLiteraturaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_literatura(this.pregunta, this.token).subscribe(
          response => {
