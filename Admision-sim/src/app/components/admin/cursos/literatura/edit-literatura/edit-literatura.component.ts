...
@Component({
  selector: 'app-edit-literatura',
  templateUrl: './edit-literatura.component.html',
  styleUrls: ['./edit-literatura.component.css']
})


export class EditLiteraturaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_literatura(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_literatura(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              this._router.navigate(['/admin/literatura']);
            }
