...
@Component({
  selector: 'app-create-biologia',
  templateUrl: './create-biologia.component.html',
  styleUrls: ['./create-biologia.component.css']
})

export class CreateBiologiaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_biologia(this.pregunta, this.token).subscribe(
          response => {
