...
@Component({
  selector: 'app-create-trigonometria',
  templateUrl: './create-trigonometria.component.html',
  styleUrls: ['./create-trigonometria.component.css']
})


export class CreateTrigonometriaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_trigonometria(this.pregunta, this.token).subscribe(
          response => {
