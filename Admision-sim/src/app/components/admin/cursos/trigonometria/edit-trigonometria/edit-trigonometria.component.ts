...
@Component({
  selector: 'app-edit-trigonometria',
  templateUrl: './edit-trigonometria.component.html',
  styleUrls: ['./edit-trigonometria.component.css']
})


export class EditTrigonometriaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_trigonometria(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_trigonometria(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              this._router.navigate(['/admin/trigonometria']);
            }
