...
@Component({
  selector: 'app-create-geografia',
  templateUrl: './create-geografia.component.html',
  styleUrls: ['./create-geografia.component.css']
})

export class CreateGeografiaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_geografia(this.pregunta, this.token).subscribe(
          response => {
