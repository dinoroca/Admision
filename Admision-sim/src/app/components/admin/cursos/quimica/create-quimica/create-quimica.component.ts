...
@Component({
  selector: 'app-create-quimica',
  templateUrl: './create-quimica.component.html',
  styleUrls: ['./create-quimica.component.css']
})

export class CreateQuimicaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_quimica(this.pregunta, this.token).subscribe(
          response => {
