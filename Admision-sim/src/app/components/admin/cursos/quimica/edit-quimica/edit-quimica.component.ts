...
@Component({
  selector: 'app-edit-quimica',
  templateUrl: './edit-quimica.component.html',
  styleUrls: ['./edit-quimica.component.css']
})


export class EditQuimicaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_quimica(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_quimica(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              this._router.navigate(['/admin/quimica']);
            }
