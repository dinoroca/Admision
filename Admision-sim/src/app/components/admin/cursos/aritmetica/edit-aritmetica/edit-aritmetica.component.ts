...
@Component({
  selector: 'app-edit-aritmetica',
  templateUrl: './edit-aritmetica.component.html',
  styleUrls: ['./edit-aritmetica.component.css']
})

export class EditAritmeticaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_aritmetica(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_aritmetica(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              this._router.navigate(['/admin/aritmetica']);
            }
