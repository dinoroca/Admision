...
@Component({
  selector: 'app-create-aritmetica',
  templateUrl: './create-aritmetica.component.html',
  styleUrls: ['./create-aritmetica.component.css']
})

export class CreateAritmeticaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_aritmetica(this.pregunta, this.token).subscribe(
          response => {
