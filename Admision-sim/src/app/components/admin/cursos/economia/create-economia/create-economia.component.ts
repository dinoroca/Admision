...
@Component({
  selector: 'app-create-economia',
  templateUrl: './create-economia.component.html',
  styleUrls: ['./create-economia.component.css']
})


export class CreateEconomiaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_economia(this.pregunta, this.token).subscribe(
          response => {
