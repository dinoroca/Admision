...
@Component({
  selector: 'app-edit-anatomia',
  templateUrl: './edit-anatomia.component.html',
  styleUrls: ['./edit-anatomia.component.css']
})

export class EditAnatomiaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_anatomia(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_anatomia(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
