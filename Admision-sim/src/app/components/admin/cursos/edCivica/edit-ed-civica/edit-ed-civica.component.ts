...
@Component({
  selector: 'app-edit-ed-civica',
  templateUrl: './edit-ed-civica.component.html',
  styleUrls: ['./edit-ed-civica.component.css']
})

export class EditEdCivicaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_ed_civica(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_ed_civica(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              this._router.navigate(['/admin/ed-civica']);
            }
