...
@Component({
  selector: 'app-create-ed-civica',
  templateUrl: './create-ed-civica.component.html',
  styleUrls: ['./create-ed-civica.component.css']
})

export class CreateEdCivicaComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_ed_civica(this.pregunta, this.token).subscribe(
          response => {
