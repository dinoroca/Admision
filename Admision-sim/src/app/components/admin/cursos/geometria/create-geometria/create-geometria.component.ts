...
@Component({
  selector: 'app-create-geometria',
  templateUrl: './create-geometria.component.html',
...
export class CreateGeometriaComponent implements OnInit {
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_geometria(this.pregunta, this.token).subscribe(
          response => {
