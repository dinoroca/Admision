...
@Component({
  selector: 'app-create-raz-verbal',
  templateUrl: './create-raz-verbal.component.html',
  styleUrls: ['./create-raz-verbal.component.css']
})


export class CreateRazVerbalComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_raz_verbal(this.pregunta, this.token).subscribe(
          response => {
