...
@Component({
  selector: 'app-edit-historia-universal',
  templateUrl: './edit-historia-universal.component.html',
  styleUrls: ['./edit-historia-universal.component.css']
})


export class EditHistoriaUniversalComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.params.subscribe(
      ...
      params => {
        ...
        this._preguntaService.obtener_pregunta_historia_universal(this.id, this.token).subscribe(
          response => {
  ...
  actualizar(actualizarForm: any) {
    ...
    if (actualizarForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.actualizar_pregunta_historia_universal(this.id, this.pregunta, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              this._router.navigate(['/admin/historia-universal']);
            }
