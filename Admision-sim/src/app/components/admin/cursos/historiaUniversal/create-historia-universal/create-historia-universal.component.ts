...
@Component({
  selector: 'app-create-historia-universal',
  templateUrl: './create-historia-universal.component.html',
  styleUrls: ['./create-historia-universal.component.css']
})


export class CreateHistoriaUniversalComponent implements OnInit {
  public token: any;
  ...
  registro(registroForm: any) {
    ...
    if (registroForm.valid) {
      if (this.valid) {
        this.load_btn = true;
        this._preguntaService.agregar_pregunta_historia_universal(this.pregunta, this.token).subscribe(
          response => {
